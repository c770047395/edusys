                    ...
                    <div class="col-lg-12 mb-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="/user/pubInfo" method="post">
                                    <div class="form-group">
                                        <label class="form-control-label text-uppercase">科目</label>
                                        <input type="text" placeholder="请输入科目" required name="sub" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label text-uppercase">具体要求</label>
                                        <textarea placeholder="请输入具体要求" required name="content" class="form-control"></textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <c:if test="${user.status == 0}"><button type="submit" class="btn btn-primary" disabled>请先缴纳押金</button></c:if>
