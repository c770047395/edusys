                    ...
                    <div class="col-lg-12 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="text-uppercase mb-0">教师列表</h6>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <c:if test="${item.status == -2 }">
                                                    <div class="badge badge-secondary">未上传资料</div>
                                                </c:if>
                                                <c:if test="${item.status == -1 }">
                                                    <div class="badge badge-primary">待审核</div>
                                                </c:if>
                                            ...
                                            <td><a class="btn btn-primary" href="/${type}/teacherDetail?id=${item.id}">查看详情</a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
