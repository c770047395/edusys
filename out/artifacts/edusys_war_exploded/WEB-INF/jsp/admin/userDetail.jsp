...
<div class="d-flex align-items-stretch">
    <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            ...
            <li class="sidebar-list-item"><a href="/${type}/toUser" class="sidebar-link text-muted active" ><i class="o-user-1 mr-3 text-gray"></i><span>用户管理</span></a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card mb-5 mb-lg-0">
                            <div class="card-header">
                                <h2 class="h6 mb-0 text-uppercase">用户审核</h2>
                            </div>
                            <div class="card-body">
                                <div class="card-body">
                                    <div class="row align-items-center flex-row">
                                        <div class="col-lg-9">
                                            <h2 class="mb-0 d-flex align-items-center"><span>${student.name}</span><span class="dot bg-green d-inline-block ml-3"></span></h2><span class="text-muted text-uppercase small">${student.sex}</span>
                                            <hr>联系电话:${student.phone}
                                        </div>
                                ...
                                <center class="py-3">
                                        ...
                                        <p class="py-5"><a href="/admin/userBan?id=${teacher.id}" class="btn btn-danger">封号</a></p>
                                </center>
                            </div>
                        </div>
                    </div>
