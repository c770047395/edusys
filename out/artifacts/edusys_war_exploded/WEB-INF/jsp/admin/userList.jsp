                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <c:if test="${item.status == 0 }">
                                                    <div class="badge badge-warning">待押金</div>
                                                </c:if>
                                                <c:if test="${item.status == 1 }">
                                                    <div class="badge badge-success">已缴纳押金</div>
                                                </c:if>
                                                <c:if test="${item.status == 2 }">
                                                    <div class="badge badge-dark">已封号</div>
                                                </c:if>
                                            </td>
                                            <td><a class="btn btn-primary" href="/${type}/userDetail?id=${item.id}">查看详情</a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
