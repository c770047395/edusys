...
<div class="d-flex align-items-stretch">
    <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            ...
            <li class="sidebar-list-item"><a href="#" data-toggle="collapse" data-target="#pages" aria-expanded="true" aria-controls="pages" class="sidebar-link text-muted"><i class="o-user-1 mr-3 text-gray"></i><span>信息设置</span></a>
                <div id="pages" class="collapse show">
                    <ul class="sidebar-menu list-unstyled border-left border-primary border-thick">
                        ...
                        <li class="sidebar-list-item"><a href="/${type}/toPassword" class="sidebar-link text-muted pl-lg-5 active">修改密码</a></li>
                    </ul>
                </div>
            </li>
                        ...
                        <div class="col-lg-12 mb-5">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="/${type}/changePassword" method="post">
