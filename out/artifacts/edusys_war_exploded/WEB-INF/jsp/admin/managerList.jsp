...
<div class="d-flex align-items-stretch">
    <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            ...
            <li class="sidebar-list-item"><a href="/${type}/toTeacherManager" class="sidebar-link text-muted " ><i class="o-user-1 mr-3 text-gray"></i><span>家教管理</span></a></li>
            <c:if test="${user.level == 1}">
                <li class="sidebar-list-item"><a href="/${type}/toManager" class="sidebar-link text-muted active" ><i class="o-user-1 mr-3 text-gray"></i><span>管理员管理</span></a></li>
            </c:if>
                    ...
                    <div class="col-lg-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="h6 text-uppercase mb-0">添加管理员</h3>
                            </div>
                            <div class="card-body">
                                <c:if test="${not empty msg}"><div class="alert-${msg_type} alert">${msg}</div></c:if>
                                <form action="/${type}/addManager" method="post">
                                    <div class="form-group">
                                        <label class="form-control-label text-uppercase">用户名</label>
                                        <input type="text" placeholder="请输入用户名" required name="username" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label text-uppercase">密码</label>
                                        <input type="password" placeholder="请输入密码" required name="password" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label text-uppercase">级别</label>
            ...
            <section >
                <div class="row">
                    <div class="col-lg-12 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="text-uppercase mb-0">管理员列表</h6>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <c:if test="${item.level == 1 }">
                                                    <div class="badge badge-warning">超级管理员</div>
                                                </c:if>
                                                <c:if test="${item.level == 2 }">
                                                    <div class="badge badge-primary">管理员</div>
                                                </c:if>
                                            </td>
                                        </tr>
                                    </c:forEach>
