            ...
            <li class="sidebar-list-item"><a href="#" data-toggle="collapse" data-target="#pages" aria-expanded="true" aria-controls="pages" class="sidebar-link text-muted"><i class="o-user-1 mr-3 text-gray"></i><span>用户</span></a>
                <div id="pages" class="collapse show">
                    <ul class="sidebar-menu list-unstyled border-left border-primary border-thick">
                        ...
                        <li class="sidebar-list-item"><a href="/${type}/toDeposit" class="sidebar-link text-muted pl-lg-5 active">押金管理</a></li>
                    </ul>
                </div>
            </li>
                    ...
                    <div class="col-lg-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="h6 text-uppercase mb-0">押金管理</h3>
                            </div>
                            <div class="card-body">
                                ...
                                <c:if test="${user.status == 1}">
                                    <center>
                                        <h1>已缴纳押金：￥1000</h1>
                                        <a href="/${type}/unDeposit" class="btn-primary btn"   data-toggle="modal" data-target="#myModal" style="margin-top: 100px">退押金</a>
                                    </center>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                退还押金：￥1000，押金退还后将限制部分操作
                                            </div>

                                            <!-- 模态框底部 -->
                                            <div class="modal-footer">
                                                <a href="/${type}/unDeposit" class="btn btn-primary" >确认</a>
                                ...
                                <c:if test="${user.status == 0}">
                                    <center>
                                        <h1>还未缴纳押金，请尽快缴纳</h1>
                                        <a href="/${type}/deposit" class="btn-primary btn"   data-toggle="modal" data-target="#myModal" style="margin-top: 100px">缴纳押金</a>
                                    </center>
                                <div class="modal fade" id="myModal">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
