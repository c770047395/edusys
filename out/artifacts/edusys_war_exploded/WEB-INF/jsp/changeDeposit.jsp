            ...
            <li class="sidebar-list-item"><a href="#" data-toggle="collapse" data-target="#pages" aria-expanded="true" aria-controls="pages" class="sidebar-link text-muted"><i class="o-user-1 mr-3 text-gray"></i><span>用户</span></a>
                <div id="pages" class="collapse show">
                    <ul class="sidebar-menu list-unstyled border-left border-primary border-thick">
                        ...
                        <li class="sidebar-list-item"><a href="/user/toDeposit" class="sidebar-link text-muted pl-lg-5 active">押金管理</a></li>
                    </ul>
                </div>
            </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <c:if test="${user.status == 1}">
                                    <center>
                                        <h1>已缴纳押金：￥1000</h1>
                                        <a href="/user/unDeposit" class="btn-primary btn" style="margin-top: 100px">退押金</a>
                                    </center>
                                </c:if>
                                <c:if test="${user.status == 0}">
                                    <center>
                                        <h1>还未缴纳押金，请尽快缴纳</h1>
                                        <a href="/user/deposit" class="btn-primary btn" style="margin-top: 100px">缴纳押金</a>
                                    </center>
                                </c:if>
                            </div>
                        </div>
